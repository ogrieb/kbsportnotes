...
\emph{One armed swings} (pendulum swings) with an oustretched arm to hip or chest 
height don't seem to be programmed in pure swing sets. Technical execution is easy 
and cardio intensity is low.
\emph{Two arm swings} are more exhausting, but it remains 
the least demanding and dull two arm exercise.

As such, one or two arm swings are more programmed in combination with another main 
exercise so as to reduce the main exercise's intensity. See for example the black 
snatch or black long cycle complexes described in the next section.

\subsubsection{Swing with Acceleration Pull}



\subsubsection{High Pull}
